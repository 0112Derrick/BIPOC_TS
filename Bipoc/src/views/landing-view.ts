...
class MemberSignUpView extends EventSource {
  constructor() {
    ...
    landingSignup.addEventListener('click', () => { this.dispatchEvent(EventConstants.SIGN_UP_HOME, null); });
    landingLogin.addEventListener('click', () => { this.dispatchEvent(EventConstants.SIGN_IN_MODAL, null); });
