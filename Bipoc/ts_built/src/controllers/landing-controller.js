...
import MemberSignUpView from '../views/landing-view';
...
class SignUpController extends Observer {
    constructor() {
        ...
        this.addEventListener(EventConstants.SIGN_UP_HOME, (e) => { this.signUpCallback(e); }, this.view);
        this.addEventListener(EventConstants.SIGN_IN_MODAL, (e) => { this.signInModalCallback(); }, this.view);
        this.addEventListener(EventConstants.SIGN_IN, (e) => { this.logInCallback(e); }, this.view);
    }
